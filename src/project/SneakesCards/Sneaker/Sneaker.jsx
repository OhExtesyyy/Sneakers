...
import s2 from "../../../assets/img/Sneakers/s2.jpg"
import s3 from "../../../assets/img/Sneakers/s3.jpg"
import s4 from "../../../assets/img/Sneakers/s4.jpg"
...
export const Sneaker = () => {
    return (
        <div className={css.sneakers}>
            <div className={css.card}>
                <div className={css.favorite}>
                    <img width={32} height={32} src={izbr} alt="izbr" />

                </div>
                <img width={133} height={112} src={s1} alt="Sneakers" />
